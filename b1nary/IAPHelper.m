...
- (void)paymentQueue:(SKPaymentQueue *)queue restoreCompletedTransactionsFailedWithError:(NSError *)error {
	[[NSNotificationCenter defaultCenter] postNotificationName:IAPHelperRestoreFailedNotification object:error userInfo:nil];
}
...
+ (NSString *)getLocalizedPrice {
	SKProduct *theProduct = [(AppDelegate *)[[UIApplication sharedApplication] delegate] getProduct];
	...
	[priceFormatter setLocale:theProduct.priceLocale];
	return [priceFormatter stringFromNumber:theProduct.price];
}
